...
const translations = {
  fa: {
    ...
    welcomeTitle: "به ShardeumAI خوش آمدید",
    welcomeSubtitle: "دستیار هوشمند بلاکچین و Web3",
    startBtn: "شروع",
  },
  en: {
    title: "ShardeumAI",
    ...
    welcomeTitle: "Welcome to ShardeumAI",
    welcomeSubtitle: "Your Intelligent Blockchain & Web3 Assistant",
    startBtn: "Start",
  },
  es: {
    title: "ShardeumAI",
    ...
    welcomeTitle: "Bienvenido a ShardeumAI",
    welcomeSubtitle: "Tu asistente inteligente de Blockchain y Web3",
    startBtn: "Comenzar",
  },
  fr: {
    title: "ShardeumAI",
    ...
    welcomeTitle: "Bienvenue sur ShardeumAI",
    welcomeSubtitle: "Votre assistant intelligent Blockchain & Web3",
    startBtn: "Commencer",
  },
  de: {
    title: "ShardeumAI",
    ...
    welcomeTitle: "Willkommen bei ShardeumAI",
    welcomeSubtitle: "Ihr intelligenter Blockchain & Web3 Assistent",
    startBtn: "Starten",
  },
  ru: {
    title: "ShardeumAI",
    ...
    welcomeTitle: "Добро пожаловать в ShardeumAI",
    welcomeSubtitle: "Ваш умный ассистент Blockchain & Web3",
    startBtn: "Начать",
  },
  ar: {
    title: "ShardeumAI",
    ...
    welcomeTitle: "مرحباً بك في ShardeumAI",
    welcomeSubtitle: "مساعدك الذكي للبلوكشين و Web3",
    startBtn: "ابدأ",
  },
};
  ...
  return (
    <div style={{
        ...
        {UI_LANGUAGES.map((lang) => (
          <button
            ...
            style={{
              ...
              border: `1px solid ${uiLang === lang.code ? "#3b82f6" : "#2b3442"}`,
              background: uiLang === lang.code ? "#111827" : "#020617",
              color: "#e8edf2", fontSize: 12, cursor: "pointer",
            }}
          >
            <span>{lang.flag}</span>
      ...
      <div style={{
        ...
        textAlign: "center",
        transform: anim ? "translateY(0)" : "translateY(30px)",
        opacity: anim ? 1 : 0,
        ...
        <div style={{
          ...
          background: "radial-gradient(circle at 30% 0%, #3b82f6, #0ea5e9 40%, #22c55e 100%)",
        ...
        <p style={{ fontSize: 16, color: "#9aa4b2", margin: "0 0 48px", maxWidth: 360, lineHeight: 1.6 }}>
          {t.welcomeSubtitle}
        </p>
        ...
        <button
          ...
          onMouseEnter={e => { e.target.style.transform = "scale(1.06)"; e.target.style.boxShadow = "0 0 45px rgba(59,130,246,0.7)"; }}
          onMouseLeave={e => { e.target.style.transform = "scale(1)"; e.target.style.boxShadow = "0 0 30px rgba(59,130,246,0.5)"; }}
        >
          {t.startBtn}
        </button>
      </div>
...
function App() {
  ...
  async function handleSend(e) {
    ...
    try {
      ...
      setMessages((prev) => [...prev, { role: "assistant", content: "خطا در دریافت پاسخ از سرور." }]);
    }
  ...
  // ── Welcome Screen ──
  if (showWelcome) {
    return <WelcomeScreen onStart={() => setShowWelcome(false)} uiLang={uiLang} setUiLang={setUiLang} />;
  }
  ...
  if (!session && showSignup) {
    return (
      <div style={styles.center} dir={isRTL ? "rtl" : "ltr"}>
        <div style={{ ...styles.card, transform: mountAnim ? "translateY(0)" : "translateY(20px)", opacity: mountAnim ? 1 : 0, transition: "all 0.5s ease" }}>
          ...
          <p style={{ textAlign: "center", fontSize: 13, color: "#9aa4b2", marginTop: 16 }}>
            ...
            <span onClick={() => setShowSignup(false)} style={{ color: "#3b82f6", cursor: "pointer" }}>Login</span>
          </p>
        </div>
      </div>
    );
      ...
      <div style={styles.center} dir={isRTL ? "rtl" : "ltr"}>
        <div style={{ ...styles.card, transform: mountAnim ? "translateY(0)" : "translateY(20px)", opacity: mountAnim ? 1 : 0, transition: "all 0.5s ease" }}>
          ...
          <p style={{ textAlign: "center", fontSize: 13, color: "#9aa4b2", marginTop: 16 }}>
            ...
            <span onClick={() => setShowSignup(true)} style={{ color: "#3b82f6", cursor: "pointer" }}>Sign up</span>
          </p>
        </div>
      </div>
    );
    ...
    <div style={{ ...styles.app, direction: isRTL ? "rtl" : "ltr" }}>
      <header style={styles.header}>
        <div style={styles.brandRow}>
          <div style={styles.logoCircle}>S</div>
          <div>
            <h1 style={{ ...styles.title, fontSize: 18 }}>{t.title}</h1>
            <p style={{ ...styles.subtitle, margin: 0 }}>{t.subtitle}</p>
          </div>
        </div>
...
const styles = {
  app: { height: "100vh", display: "flex", flexDirection: "column", background: "radial-gradient(circle at top, #1f2937 0, #020617 45%, #000 100%)", color: "#e8edf2", fontFamily: "system-ui, -apple-system, BlinkMacSystemFont, sans-serif" },
  ...
  header: { padding: "16px 20px", borderBottom: "1px solid #1f2937", display: "flex", justifyContent: "space-between", alignItems: "center", backdropFilter: "blur(12px)", background: "rgba(2,6,23,0.85)" },
  ...
  main: { flex: 1, display: "flex", flexDirection: "column", padding: "14px 20px 18px", gap: 12 },
  chatWrapper: { flex: 1, borderRadius: 20, border: "1px solid #1f2937", background: "radial-gradient(circle at top left, #0f172a 0, #020617 55%, #000 100%)", padding: 12, boxShadow: "0 18px 60px rgba(0,0,0,0.7)" },
  ...
  composer: { display: "flex", gap: 10, alignItems: "center", marginTop: 10 },
