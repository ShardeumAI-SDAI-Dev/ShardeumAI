                ...
                {messages.map((msg, idx) => (
                  <div key={idx} style={{
                    ...
                    {msg.role === "user" ? (
                      ...
                      <div style={{ ...styles.assistantMessage, maxWidth: "100%" }} dir="auto">
                        <ReactMarkdown
  ...
  {msg.content}
            ...
            <form onSubmit={handleSend} style={styles.composer}>
              <textarea
                ...
                rows={1}
              />
              <button type="submit" disabled={!input.trim() || chatLoading} style={styles.sendBtn}>➤</button>
            </form>
          </>
        ) : activeTab === "image" ? (
...
const styles = {
  app: { height: "100vh", display: "flex", flexDirection: "column", background: "#212121", color: "#ececec", fontFamily: "'Vazirmatn', system-ui, -apple-system, sans-serif" },
  center: { display: "flex", alignItems: "center", justifyContent: "center", height: "100vh", background: "#212121" },
  card: { background: "#2d2d2d", border: "1px solid #3d3d3d", borderRadius: 16, padding: "32px 28px", width: "100%", maxWidth: 420, boxShadow: "0 24px 60px rgba(0,0,0,0.5)", color: "#ececec" },
  ...
  subtitle: { marginTop: 4, fontSize: 12, color: "#8e8ea0" },
  form: { marginTop: 20, display: "flex", flexDirection: "column", gap: 12 },
  input: { padding: "11px 14px", borderRadius: 10, border: "1px solid #3d3d3d", background: "#2d2d2d", color: "#ececec", fontSize: 14, outline: "none" },
  button: { marginTop: 8, padding: "11px 0", borderRadius: 10, border: "none", background: "#10a37f", color: "#fff", fontSize: 14, fontWeight: 600, cursor: "pointer" },
  header: { padding: "8px 14px", borderBottom: "1px solid #2d2d2d", display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: 8, background: "#212121", flexShrink: 0 },
  ...
  label: { fontSize: 10, color: "#8e8ea0" },
  flagSelect: { display: "flex", flexWrap: "wrap", gap: 4, maxWidth: 220 },
  flagBtn: { display: "flex", alignItems: "center", gap: 4, padding: "4px 8px", borderRadius: 8, border: "1px solid #3d3d3d", background: "#2d2d2d", color: "#ececec", fontSize: 10, cursor: "pointer" },
  flagIcon: { fontSize: 13 },
  flagLabel: { fontSize: 10 },
  logoutBtn: { padding: "6px 12px", borderRadius: 8, border: "1px solid #3d3d3d", background: "transparent", color: "#ececec", fontSize: 12, cursor: "pointer" },
  main: { flex: 1, display: "flex", flexDirection: "column", padding: "8px 12px 12px", gap: 8, overflow: "hidden" },
  chatWrapper: { flex: 1, borderRadius: 12, border: "1px solid #2d2d2d", background: "#212121", overflow: "hidden" },
  chat: { height: "100%", background: "#212121", padding: "16px", overflowY: "auto", fontSize: 15, display: "flex", flexDirection: "column", gap: 4, fontFamily: "'Vazirmatn', system-ui, sans-serif", lineHeight: 1.85 },
  userMessage: { background: "#2d2d2d", color: "#ececec", padding: "12px 16px", borderRadius: 16, lineHeight: 1.8, fontSize: 15, maxWidth: "80%", alignSelf: "flex-end", wordBreak: "break-word" },
  assistantMessage: { background: "transparent", color: "#ececec", padding: "8px 4px", lineHeight: 1.85, fontSize: 15, width: "100%" },
  loadingRow: { display: "flex", gap: 5, padding: "8px 4px", alignItems: "center" },
  dot: { width: 7, height: 7, borderRadius: "50%", background: "#10a37f", animation: "pulse 1.2s infinite ease-in-out" },
  composer: { display: "flex", gap: 8, alignItems: "flex-end" },
  composerInput: { flex: 1, padding: "12px 16px", borderRadius: 14, border: "1px solid #3d3d3d", background: "#2d2d2d", color: "#ececec", fontSize: 14, outline: "none", fontFamily: "inherit", lineHeight: 1.6 },
  sendBtn: { width: 42, height: 42, borderRadius: 10, border: "none", background: "#10a37f", color: "#fff", fontSize: 16, fontWeight: 700, cursor: "pointer", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center" },
};
